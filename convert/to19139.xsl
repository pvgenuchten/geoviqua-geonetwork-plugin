...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
	...
	<xsl:template match="gvq:GVQ_Metadata" priority="400">
	...
	<xsl:template match="*[@gco:isoType and name()!='gvq:GVQ_Metadata']" priority="100">
	...
	<xsl:template match="*[namespace-uri()='http://www.geoviqua.org/QualityInformationModel/4.0']"/>
