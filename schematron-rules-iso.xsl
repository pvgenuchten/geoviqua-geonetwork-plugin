...
<xsl:variable name="loc" select="document(concat('loc/', $lang, '/', substring-before($rule, '.xsl'), '.xml'))" xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
...
<!--SCHEMA SETUP-->
<xsl:template match="/">
<svrl:schematron-output title="Schematron validation for ISO&#10;&#9;&#9;19115(19139)" schemaVersion="" xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
<xsl:comment>
...
<xsl:variable name="access" select="(not(gmd:otherConstraints) or not(string(gmd:otherConstraints/gco:CharacterString)) or gmd:otherConstraints/@gco:nilReason='missing')"/>
...
<xsl:copy-of select="$loc/strings/M21"/>
	...
	<!--RULE -->
<xsl:template match="//gmd:MD_DataIdentification|//*[@gco:isoType='gmd:MD_DataIdentification']" priority="1000" mode="M20">
...
<xsl:copy-of select="$loc/strings/M22"/>
	...
	<!--RULE -->
<xsl:template match="//gmd:MD_DataIdentification|//*[@gco:isoType='gmd:MD_DataIdentification']" priority="1000" mode="M21">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//gmd:MD_DataIdentification|//*[@gco:isoType='gmd:MD_DataIdentification']"/>
...
<xsl:copy-of select="$loc/strings/M25"/>
	...
	<!--RULE -->
<xsl:template match="//gvq:GVQ_Metadata|//*[@gco:isoType='gvq:GVQ_Metadata']" priority="1000" mode="M23">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//gvq:GVQ_Metadata|//*[@gco:isoType='gvq:GVQ_Metadata']"/>
...
<xsl:copy-of select="$loc/strings/M61"/>
	...
	<!--RULE -->
<xsl:template match="//gvq:GVQ_Metadata/gmd:hierarchyLevel|//*[@gco:isoType='gvq:GVQ_Metadata']/gmd:hierarchyLevel" priority="1000" mode="M29">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//gvq:GVQ_Metadata/gmd:hierarchyLevel|//*[@gco:isoType='gvq:GVQ_Metadata']/gmd:hierarchyLevel"/>
