...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="analyze-inspire-themes-and-topiccategory">
        <xsl:param name="root"/>
        <xsl:variable name="lang" select="if (normalize-space($root//gvq:GVQ_Metadata/gmd:language/gco:CharacterString
            |$root//gvq:GVQ_Metadata/gmd:language/gmd:LanguageCode/@codeListValue)='') 
            then 'en' 
            else
            substring($root//gvq:GVQ_Metadata/gmd:language/gco:CharacterString
            |$root//gvq:GVQ_Metadata/gmd:language/gmd:LanguageCode/@codeListValue, 1, 2)
            "/>
    ...
    <xsl:template
        ...
        <xsl:copy>
            ...
            -->
            <xsl:variable name="lang" select="if (normalize-space(//gvq:GVQ_Metadata/gmd:language/gco:CharacterString
                |//gvq:GVQ_Metadata/gmd:language/gmd:LanguageCode/@codeListValue)='') 
                then 'en' 
                else
                substring(//gvq:GVQ_Metadata/gmd:language/gco:CharacterString
                |//gvq:GVQ_Metadata/gmd:language/gmd:LanguageCode/@codeListValue, 1, 2)
                "/>
