...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- ===================================================================== -->
  <!-- iso19139-simple -->
  <xsl:template name="metadata-iso19139.geoviquaview-simple" match="metadata-iso19139.geoviquaview-simple">
    <!--<xsl:apply-templates mode="iso19139-simple" select="*"/>-->

    <xsl:call-template name="view-with-header-iso19139.geoviqua">
      <xsl:with-param name="tabs">
        <xsl:call-template name="complexElementSimpleGui">
          ...
          <xsl:with-param name="content">
            ...
            <xsl:apply-templates mode="block-geoviqua" select="gmd:identificationInfo/*/gmd:extent/*/gmd:geographicElement"/>
          </xsl:with-param>
        </xsl:call-template>
  ...
  <xsl:template mode="block-geoviqua" match="gmd:geographicElement">
    <xsl:apply-templates mode="iso19139.geoviqua" select="gmd:EX_GeographicBoundingBox">
      <xsl:with-param name="schema" select="$schema"/>
      <xsl:with-param name="edit" select="false()"/>
    </xsl:apply-templates>
  </xsl:template>
