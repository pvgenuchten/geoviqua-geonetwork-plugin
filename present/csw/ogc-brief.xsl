...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="gvq:GVQ_Metadata|*[@gco:isoType='gvq:GVQ_Metadata']">
		...
		<csw:BriefRecord>
			...
			<xsl:for-each select="$identification/gmd:extent/gmd:EX_Extent/gmd:geographicElement/gmd:EX_GeographicBoundingBox|
				...
				<xsl:variable name="rsi"  select="/gvq:GVQ_Metadata/gmd:referenceSystemInfo/gmd:MD_ReferenceSystem/
					gmd:referenceSystemIdentifier/gmd:RS_Identifier|/gvq:GVQ_Metadata/gmd:referenceSystemInfo/
